...
public class AnonymousStats extends SettingsPreferenceFragment implements
    ...
    private static final String PREF_FILE_NAME = "anonymous_stats";
        ...
        if (preference == mEnableReporting) {
            if (mEnableReporting.isChecked()) {
                ...
                mOkDialog = new AlertDialog.Builder(getActivity())
                        .setMessage(R.string.anonymous_statistics_about)
                        .setTitle(R.string.anonymous_statistics_about_title)
            ...
            Uri uri = Uri.parse(context.getString(R.string.stats_view_url));
