...
public class LockscreenExtras extends SettingsPreferenceFragment implements
    ...
    private PreferenceScreen createCustomLockscreenView() {
        ...
        addPreferencesFromResource(R.xml.lockscreen_extra_settings);
    ...
    public static class MyAlertDialogFragment extends DialogFragment {
        ...
        LockscreenExtras getOwner() {
            return (LockscreenExtras) getTargetFragment();
        }
