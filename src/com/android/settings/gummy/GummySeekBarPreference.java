...
public class GummySeekBarPreference extends Preference implements OnSeekBarChangeListener {
    ...
    public GummySeekBarPreference(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void setValuesFromXml(AttributeSet attrs) {
        ...
        mUnitsLeft = getAttributeStringValue(attrs, SETTINGS, "unitsL", "");
        String units = getAttributeStringValue(attrs, SETTINGS, "units", "");
        mUnitsRight = getAttributeStringValue(attrs, SETTINGS, "unitsR", units);
    ...
    /**
     * Update a GummySeekBarPreference view with our current state
     * @param view
     */
